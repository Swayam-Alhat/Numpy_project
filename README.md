...
### Array Manipulation - Reshaping & Resizing
...
> We can pass -1 as an argument when we are unsure about a particular dimension — NumPy will automatically calculate it based on the array size and the other given dimensions

```python
array1.reshape(2, -1)  # NumPy auto-calculates columns
# Output: [[1 2 3]
#          [4 5 6]]
